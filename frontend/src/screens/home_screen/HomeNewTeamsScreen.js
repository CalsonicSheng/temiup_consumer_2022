...
import { getNewTeamsRequestHandler } from '../../data/slices/teamSlice';

export default function HomeNewTeamsScreen() {
  ...
  useEffect(() => {
    ...
    dispatch(getNewTeamsRequestHandler([lowerCasedCategory, selectedPageStateDecrement]));
